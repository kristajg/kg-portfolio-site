      ...
      <div className='content-body'>
        <div className='content-flex-container'>
          ...
          <p className='bio-paragraph'>
            ...
            I know the full gamut of what it takes to conceptualize &#38; build a fullstack product - then take it to market. My preferred code stack is <b>React + Node.js</b>.<br />
