...
export const Footer = () => {
  return (
    <div className='footer-container'>
      <div>Copyright 2026 © Krista Goralczyk. Built with React &#38; Sass, <a href='https://github.com/kristajg/kg-portfolio-site' target='_blank' rel='noreferrer'>view source code here</a>.</div>
      <hr />
